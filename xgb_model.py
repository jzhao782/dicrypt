...
X = pd.read_csv(data_dir + 'X.csv', index_col = 'Composition') # read in data
y = pd.read_csv(data_dir + 'y.csv', index_col = 'Composition') # read in data
y_mean = pd.read_csv(data_dir + 'y.csv', index_col = 'Composition')
